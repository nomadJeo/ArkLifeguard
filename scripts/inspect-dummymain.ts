...
function help(): void {
    console.log([
        ...
        '  --model <flat|back-edge|hierarchical|bounded-unroll>  Lifecycle model; default: flat',
...
function parseArgs(args: string[]): Options {
    ...
    if (!['flat', 'back-edge', 'hierarchical', 'bounded-unroll'].includes(model)) {
        throw new Error(`Invalid --model: ${model}; expected flat, back-edge, hierarchical, or bounded-unroll`);
    }
